...
const resolvePackageFallback = function (moduleName, baseDirs, error) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const packagePath = yield (0, find_up_1.default)(isPackageDir.bind(null, moduleName), { cwd: mainFilePath, type: 'directory' });
...
const isPackageDir = function (moduleName, dir) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        if (!dir.replace(BACKSLASH_REGEXP, '/').endsWith(moduleName) || !(yield (0, path_exists_1.default)(`${dir}/package.json`))) {
            return;
        }
        return dir;
    });
